...
async def _(event):
   ...
   # input_str = event.pattern_match.group(1)
    ...
    animation_chars = [
        ...
        "Heroku Connecting To Latest Github Build (LitchUbot/Litch-Ubot)",
        ...
        "INFO - Litch-Ubot: Logged in as 557667062",
        "INFO - Litch-Ubot: Successfully...",
        "919852+00:00 app[worker.1]: 919 - Litch-Ubot -",
        "INFO -  ⚡LITCH-UBOT⚡  ⚙️ V5.0 [TELAH DIAKTIFKAN!]",
        "**Build Succeeded**"
